...
class LightGCN(pl.LightningModule):
    ...
    def forward(self, adj_matrix):
       ...
       emb1 = self.conv1(emb0, self.edge_index)
       emb2 = self.conv2(emb1, self.edge_index)
       emb3 = self.conv3(emb2, self.edge_index)
    ...
    def encode_minibatch(self, users, pos_items, neg_items):
        emb0, out = self.forward(None)
        return (
           out[users],
           out[pos_items],
           out[neg_items],
