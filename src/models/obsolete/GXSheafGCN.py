...
class GXSheafGCNLayer(nn.Module):
    def __init__(self, dimx, dimy, nsmat=64):
        super(GXSheafGCNLayer, self).__init__()
        self.dimx = dimx
        self.dimy = dimy
...
class GXSheafGCN(pl.LightningModule):
    def __init__(self,
                 latent_dim,
                 dataset):
        super(GXSheafGCN, self).__init__()
        ...
        self.sheaf_conv1 = GXSheafGCNLayer(latent_dim, latent_dim, 40)
        self.sheaf_conv2 = GXSheafGCNLayer(latent_dim, latent_dim, 40)
        self.sheaf_conv3 = GXSheafGCNLayer(latent_dim, latent_dim, 40)
